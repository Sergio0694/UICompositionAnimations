...
namespace UICompositionAnimations.Behaviours.Effects.Base
{
    ...
    public abstract class AttachedAnimatableCompositionEffectBase<T> : AttachedStaticCompositionEffect<T>, IAttachedFixedCompositionEffect where T : FrameworkElement
    {
        // Protected constructor for the implementations
        internal AttachedAnimatableCompositionEffectBase([NotNull] T element, [NotNull] SpriteVisual sprite, [NotNull] CompositionEffectBrush effectBrush)
