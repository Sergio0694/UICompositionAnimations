...
namespace UICompositionAnimationsLegacy.Animations.Interfaces
{
    ...
    public interface IAnimationBuilder
    {
        ...
        /// <param name="ease">The EasingFunctionNames function to use for the opacity animation</param>
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Opacity(double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        /// <param name="ease">The EasingFunctionNames function to use for the opacity animation</param>
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Opacity(double from, double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Translation(TranslationAxis axis, double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        /// <param name="ease">The EasingFunctionNames function to use for the translation animation</param>
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Translation(TranslationAxis axis, double from, double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Offset(TranslationAxis axis, double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        /// <param name="ease">The EasingFunctionNames function to use for the offset animation</param>
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Offset(TranslationAxis axis, double from, double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Scale(double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        /// <param name="ease">The EasingFunctionNames function to use for the scale animation</param>
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Scale(double from, double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Rotate(double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        /// <param name="ease">The EasingFunctionNames function to use for the rotation animation</param>
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Rotate(double from, double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Clip(MarginSide side, double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        /// <param name="ease">The EasingFunctionNames function to use for the clip animation</param>
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Clip(MarginSide side, double from, double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Size(TranslationAxis axis, double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        /// <param name="ease">The easing function to use for the size animation</param>
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Size(TranslationAxis axis, double from, double to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        /// <param name="ease">The easing function to use for the size animation</param>
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Size(Vector2 to, EasingFunctionNames ease = EasingFunctionNames.Linear);
        ...
        /// <param name="ease">The easing function to use for the size animation</param>
        [MustUseReturnValue, NotNull]
        IAnimationBuilder Size(Vector2 from, Vector2 to, EasingFunctionNames ease = EasingFunctionNames.Linear);
